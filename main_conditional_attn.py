...
def parse_args():
    ...
    parser.add_argument('--c2', type=float, default=0.1)       #default 0.1
    parser.add_argument('--c3', type=float, default=0.1)       #default 0.1
    ...
    parser.add_argument('--n_high_cov', type=int, default=1)   #default 1
